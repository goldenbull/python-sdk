...
Constant* Util::createDecimal32(int scale, int value) {
	Decimal32 *decimal = new Decimal32(scale, (int32_t)value);
	return decimal;
}
...
ConstantSP Util::createValue(DATA_TYPE dataType, long long val, const char *pTypeName, ErrorCodeInfo *errorCodeInfo, int extraParam) {
	...
	case DATA_TYPE::DT_DECIMAL32:
		return createDecimal32(extraParam, (int)val);
		break;
