...
TEST_F(ScalarTest,test_decimal32){
    ...
    EXPECT_ANY_THROW(ConstantSP decimalval1 = Util::createDecimal32(0, 10000000000.0)); //scale + value's places must less than 10
	...
	EXPECT_EQ(decimalval1->compare(0,Util::createDecimal64(1,1.0)),0.0);
...
TEST_F(ScalarTest,test_Decimal64){
    ...
    EXPECT_FALSE(decimalval1->assign(Util::createDecimal64(0,-10000000000000000.0)));
    EXPECT_FALSE(decimalval1->assign(Util::createDecimal64(0,10000000000000000.0)));
	...
	EXPECT_EQ(decimalval1->compare(0,Util::createDecimal64(11,1.0)),0.0);
	EXPECT_EQ(decimalval1->compare(0,Util::createDecimal64(18,0.999999999)),1.0);
	EXPECT_EQ(decimalval1->compare(0,Util::createDecimal64(10,2.00001)),-1.0);
	EXPECT_EQ(decimalval1->compare(0,Util::createDecimal64(11,1.0)),0.0);
    EXPECT_EQ(decimalval1->compare(0,Util::createNullConstant(DT_DECIMAL64)), 1);
    EXPECT_EQ(decimalval1->compare(0, Util::createFloat(1.001)), -1);
    EXPECT_EQ(decimalval1->compare(0, Util::createDouble(0.99)), 1);
    ...
    ConstantSP decimalval4 = Util::createDecimal64(0, 100.0);
